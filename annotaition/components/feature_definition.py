...
class FeatureDataFieldsDefinitionList(list):
    def __init__(self, data_fields_list, *args, **kwargs):
        super(FeatureDataFieldsDefinitionList, self).__init__(*args, **kwargs)
...
class FeatureDefinition():
    def __init__(self, feature_definition_dict):
        ...
        self.data_fields = FeatureDataFieldsDefinitionList(data_fields)
